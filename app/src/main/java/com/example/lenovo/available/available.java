...
import com.example.lenovo.available.Adapters.CustomAdapter;
...
public class available extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        list.add(new DataModel("Brahma Gana Sabha","र 500","8 OCT,2016"));
        list.add(new DataModel("Rasika Ranjani Sabha","र 500","8 OCT,2016"));
